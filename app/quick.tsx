...
export default function QuickScreen() {
  ...
  // Helper function to calculate product total with additional tax and IVA
  const calculateProductTotal = (product) => {
    ...
    console.log(`Additional Tax Data:`, product.additionalTax);
    ...
    if (product.additionalTax) {
      ...
      console.log(`Additional Tax Rate: ${product.additionalTax.rate}`);
  ...
  // Format price as integer (for display in product cards)
  ...
  const selectProduct = (apiProduct: Product) => {
    ...
    console.log('Additional Tax Rate:', formattedProduct.additionalTax?.rate);
    console.log('Price Formatted:', formatPriceAsInteger(formattedProduct.price));
